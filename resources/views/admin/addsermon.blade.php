                            ...
                            <div class="card">
                                <div class="body">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select name="category_id" class="form-control selectpicker show-tick"
                                    ...
                                    <div class="form-group">
                                        <label for="category_desc">Sermon Description</label>
                                        <textarea class="form-control" name="category_desc" id="description"></textarea>
                                    </div>

                                    <div class="form-group mb-4">
                                        <label for="category_name">Preacher</label>
                                        <input type="text" class="form-control" name="preacher"
                                            placeholder="Enter Sermon Name" />
                                    </div>

                                    <div class="form-group mb-4">
                                        <label for="category_name">File</label>
                                        <input type="file" class="form-control" name="sermon_file" />
                                    </div>

                                    <button type="submit" onclick="handleFormSubmit(event)"
                                        class="btn btn-info waves-effect m-t-20">Add</button>
