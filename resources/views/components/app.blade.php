...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('ccm/img/ccm-01.png') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('ccm/css/color-schemes/skin-main.css') }}"
        id="css-default" />
    <!-- End: CSS Stylesheets -->
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="navbar-header">
                            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse"
                                data-target="#theme-main-nav-menu" aria-expanded="false">
            ...
            <div class="container">
                <div class="high-padding row">
                    <div class="widget widget_text col-md-6">
                        <a href="{{ route('page.home') }}" class="footer-logo">
                            <img src="{{ asset('ccm/img/ccm-logo-dark-text.png') }}" alt="" />
                        </a>
                        <div class="spacer_10"></div>

                        <p>This Ministry known as Christianity in Christ Ministry is Word-Revelation based Ministry. The
                            call forth of this ministry is out of the Revelations from the Word of God and Personal
                            Convictions arising from deeper insights into the Word of God, which had provoked a deeper
                            desire towards making full proof of the Gospel Ministry. This is the first cause that led to
                            the pursuance of this great calling regarding the Ministry.</p>
            ...
            <div class="container">
                <div class="row animateIn" data-animate="fadeIn">
                    <div class="copyright-informations text-left col-md-6">
                        Developed By <a href="https://opeyemiayanyemi.dev">Opeyemi Ayanyemi</a>
                    </div>
                    <div class="text-right col-md-6">
                        <ul class="menu">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('page.sermons') }}">Sermons</a>
                            </li>
                            <li class="menu-item">
                                <a href="{{ route('page.books') }}">Books</a>
                            </li>
                            <li class="menu-item">
